...
switch (game)
	...
	for (int x=0; x<1025;x++)
		{	//read in master object list
			...
			//printf("Item ID %d %d\n",x, objList[x].item_id);
			objList[x].flags  = ((getValAtAddress(lev_ark,objectsAddress+address_pointer+0,16))>> 9) & 0x07;
			...
			objList[x].heading =  (((getValAtAddress(lev_ark,objectsAddress+address_pointer+2,16)) >> 7) & 0x07); //bits 7-9
